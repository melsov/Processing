...
public class Settings 
{
	...
	public static final Pointt PAPER_DIMENSIONS = new Pointt(610, 457);
	public static int MachineWidth = 940;
	public static final Pointt PAPER_UPPER_LEFT_CORNER = new Pointt((MachineWidth - PAPER_DIMENSIONS.x) * .5f, GONDOLA_HOME_POINT_HEIGHT_MM);
